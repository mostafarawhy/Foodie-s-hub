    ...
    >
      <div className=" flex items-center justify-center min-h-screen">
        <div
          ...
          aria-hidden="true"
        ></div>
        <div className=" bg-slate-900 relative  rounded-lg px-6 py-8 w-full max-w-md">
          ...
          <form>
            ...
            <div className="mb-6">
              ...
              <input
                ...
                className="mt-4 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50"
              />
              <div className="text-sm text-pink-500 mt-5">
          ...
          <button
            className="absolute top-4 right-4 text-pink-300 hover:text-white focus:outline-none"
